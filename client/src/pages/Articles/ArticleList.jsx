                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {articles.map((article) => (
                        <Link
                            ...
                            className="bg-white/40 dark:bg-black/20 backdrop-blur-md rounded-xl shadow-lg border border-white/20 dark:border-white/10 p-6 hover:shadow-xl hover:bg-white/50 dark:hover:bg-black/30 transition-all border-white/20"
                        >
