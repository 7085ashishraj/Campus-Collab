                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 sm:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-white dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                            rows="2"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm font-mono text-sm bg-white dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                            rows="8"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                {...register('visibility')}
                                className="block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 bg-white dark:bg-gray-700 dark:text-white"
                            >
                    ...
                    <div className="pt-4 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
                        <Link
                            to="/dashboard"
                            className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                            Cancel
                        </Link>
                        <button
