                                                                                      Campus Collab 🎓🤝
                                                      Campus Collab is a centralized platform designed to bridge the gap between students, enabling them to discover projects,
                                                      find potential collaborators, and share resources within their academic community.
                                                              ...
                                                              - State Management: Redux or Context API
                                                                ...
                                                                📋 Prerequisites
                                                                    ...
                                                                    - Backend dependencies:
                                                                      npm install
                                                                    - Frontend dependencies (if separate client directory):
                                                                    cd client
                                                                    npm install
                                                                    ...
                                                                    - Run the application
                                                                    - From the root (using concurrently or individually):
                                                                    npm run dev
